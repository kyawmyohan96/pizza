                ...
                <div class="">
                    <div class="py-5 text-center">
                       ...
                       <div class="text-center m-4 p-2">
                        ...
                        <div class="">
                            <!-- <input type="submit" value="submit" class="btn bg-dark text-white"> -->
                            <button type="submit"  class="btn bg-dark text-white">Search <i class="fa-solid fa-magnifying-glass"></i></button>
                        </div>
                       </form>
                    </div>
                </div>
            ...
            @if($status==1)
                ...
                <div class="col-4 mb-5">
                        ...
                        <div class="card h-100"   >
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="{{asset('uploads/'.$item->image)}}" id="pizza-image" alt="..." />
                            <!-- Product details-->
