                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="{{route('admin#createPizza')}}"><button class="btn btn-sm bg-dark text-white mt-1"><i class="fa-solid fa-plus"></i></button></a>
                                    ...
                                    <tr>
                                        ...
                                        <button class="btn btn-sm bg-dark text-white"><i class="fas fa-edit"></i></button>
                                            ...
                                            <a href="{{route('admin#pizzaInfo',$item->pizza_id)}}">
                                                <button class="btn btn-sm bg-primary text-white"><i class="fa-solid fa-eye"></i></button>
